package com.api.expose.system.service.social;
...
import com.api.expose.framework.common.util.cache.CacheUtils;
import com.api.expose.framework.common.util.http.HttpUtils;
import com.api.expose.framework.common.util.object.BeanUtils;
import com.api.expose.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.api.expose.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import com.api.expose.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import com.api.expose.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import com.api.expose.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.api.expose.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.api.expose.system.dal.dataobject.social.SocialClientDO;
import com.api.expose.system.dal.mysql.social.SocialClientMapper;
import com.api.expose.system.dal.redis.RedisKeyConstants;
import com.api.expose.system.enums.social.SocialTypeEnum;
import com.api.expose.system.framework.justauth.core.AuthRequestFactory;
...
import static com.api.expose.framework.common.util.collection.MapUtils.findAndThen;
import static com.api.expose.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.api.expose.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
import static com.api.expose.framework.common.util.json.JsonUtils.toJsonString;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${apex.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${apex.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/apex-cloud/pulls/230
