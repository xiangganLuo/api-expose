package com.api.expose.system.controller.admin.auth;
...
import com.api.expose.framework.security.config.SecurityProperties;
...
import com.api.expose.system.service.auth.AdminAuthService;
...
import com.api.expose.system.service.social.SocialClientService;
...
public class AuthController {
    ...
    // 可按需开启限流：https://github.com/YunaiV/api_expose/issues/851
    ...
    public CommonResult<AuthLoginRespVO> socialQuickLogin(@RequestBody @Valid AuthSocialLoginReqVO reqVO) {
        log.info("进来时的code：" + reqVO.getCode());
        return success(authService.socialLogin(reqVO));
    }

    @PostMapping("/access-token-login")
    @Operation(summary = "钉钉应用内免登录")
    @PermitAll
    public CommonResult<AuthLoginRespVO> accessTokenLogin(@RequestBody @Valid AuthSocialLoginReqVO reqVO) {
        return success(authService.accessTokenLogin(reqVO));
    }
