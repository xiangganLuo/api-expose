package com.api.expose.system.service.sms;

import com.api.expose.framework.common.pojo.PageResult;
import com.api.expose.framework.common.util.object.BeanUtils;
import com.api.expose.system.controller.admin.sms.vo.channel.SmsChannelPageReqVO;
import com.api.expose.system.controller.admin.sms.vo.channel.SmsChannelSaveReqVO;
import com.api.expose.system.dal.dataobject.sms.SmsChannelDO;
import com.api.expose.system.dal.mysql.sms.SmsChannelMapper;
import com.api.expose.system.framework.sms.core.client.SmsClient;
import com.api.expose.system.framework.sms.core.client.SmsClientFactory;
...
import static com.api.expose.system.enums.ErrorCodeConstants.SMS_CHANNEL_HAS_CHILDREN;
import static com.api.expose.system.enums.ErrorCodeConstants.SMS_CHANNEL_NOT_EXISTS;
