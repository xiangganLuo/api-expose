...
import com.api.expose.framework.common.validation.Mobile;
import com.api.expose.system.framework.operatelog.core.DeptParseFunction;
import com.api.expose.system.framework.operatelog.core.PostParseFunction;
import com.api.expose.system.framework.operatelog.core.SexParseFunction;
...
public class UserSaveReqVO {
    ...
    @Schema(description = "用户账号", requiredMode = Schema.RequiredMode.REQUIRED, example = "apex")
    ...
    @Schema(description = "用户邮箱", example = "apex@iocoder.cn")
