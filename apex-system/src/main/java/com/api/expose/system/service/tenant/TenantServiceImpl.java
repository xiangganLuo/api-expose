package com.api.expose.system.service.tenant;
...
import com.api.expose.framework.tenant.config.TenantProperties;
...
import com.api.expose.system.controller.admin.permission.vo.role.RoleSaveReqVO;
import com.api.expose.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import com.api.expose.system.controller.admin.tenant.vo.tenant.TenantSaveReqVO;
import com.api.expose.system.convert.tenant.TenantConvert;
...
import com.api.expose.system.dal.dataobject.tenant.TenantDO;
import com.api.expose.system.dal.dataobject.tenant.TenantPackageDO;
import com.api.expose.system.dal.mysql.tenant.TenantMapper;
import com.api.expose.system.enums.permission.RoleCodeEnum;
import com.api.expose.system.enums.permission.RoleTypeEnum;
import com.api.expose.system.service.permission.MenuService;
...
import com.api.expose.system.service.tenant.handler.TenantInfoHandler;
import com.api.expose.system.service.tenant.handler.TenantMenuHandler;
...
public class TenantServiceImpl implements TenantService {
    ...
    @Autowired(required = false) // 由于 apex.tenant.enable 配置项，可以关闭多租户的功能，所以这里只能不强制注入
    ...
    @DataPermission(enable = false) // 参见 https://gitee.com/zhijiantianya/api_expose/pulls/1154 说明
