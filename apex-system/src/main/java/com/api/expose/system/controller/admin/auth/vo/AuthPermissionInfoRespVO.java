package com.api.expose.system.controller.admin.auth.vo;
...
public class AuthPermissionInfoRespVO {
    ...
    public static class UserVO {
        ...
        @Schema(description = "多部门编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "2048")
    ...
    public static class MenuVO {
        ...
        @Schema(description = "菜单名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "APEX")
        private Long id;
