package com.api.expose.system.mq.producer.mail;
...
public class MailProducer {
    ...
    public void sendMailSendMessage(Long sendLogId, String mail, Long accountId,
        ...
        sendMailSendMessage(sendLogId, mail, accountId, nickname, title, content, null);
    }

    /**
     * 发送 {@link MailSendMessage} 消息（带附件）
     *
     * @param sendLogId 发送日志编码
     * @param mail 接收邮件地址
     * @param accountId 邮件账号编号
    ...
    public void sendMailSendMessage(Long sendLogId, String mail, Long accountId,
                                    String nickname, String title, String content,
                                    List<MailSendMessage.MailAttachment> attachments) {
