...
import com.api.expose.system.controller.admin.oauth2.vo.user.OAuth2UserInfoRespVO;
import com.api.expose.system.controller.admin.oauth2.vo.user.OAuth2UserUpdateReqVO;
...
public class OAuth2UserController {
    ...
    public CommonResult<OAuth2UserInfoRespVO> getUserInfo() {
        ...
        if (CollUtil.isNotEmpty(user.getDeptIds())) {
            List<DeptDO> depts = deptService.getDeptList(user.getDeptIds());
            resp.setDepts(BeanUtils.toBean(depts, OAuth2UserInfoRespVO.Dept.class));
        }
        // 获得岗位信息
