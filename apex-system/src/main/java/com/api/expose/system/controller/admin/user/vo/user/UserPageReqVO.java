...
public class UserPageReqVO extends PageParam {
    ...
    @Schema(description = "用户昵称，模糊匹配", example = "apex")
    private String nickname;

    @Schema(description = "用户账号", example = "apex")
    private String username;

    @Schema(description = "手机号码，模糊匹配", example = "apex")
    ...
    private Long deptId;
    @Schema(description = "多部门编号，同时筛选子部门", example = "1024")
    private LinkedHashSet<Long> deptIds;

    @Schema(description = "角色编号", example = "1024")
    private Long roleId;

    @Schema(description = "岗位名称，模糊匹配", example = "经理")
