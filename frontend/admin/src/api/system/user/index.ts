...
export const importUserRoleTemplate = () => {
  return request.download({ url: '/system/user/get-import-user-role-template' })
}

// 根据业务模块获取用户列表
export const getUserListByBusinessModule = (moduleCode: string): Promise<UserVO[]> => {
  return request.get({ url: '/system/user/list-by-business-module', params: { moduleCode } })
}