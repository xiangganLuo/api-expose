...
v-model="queryParams.nickname" placeholder="请输入用户昵称" clearable @keyup.enter="handleQuery"
          ...
          <el-form-item label="岗位名称" prop="postname">
            <el-input
v-model="queryParams.postname" placeholder="请输入岗位名称" clearable @keyup.enter="handleQuery"
              class="!w-240px" />
          </el-form-item>
...
v-for="dict in getIntDictOptions(DICT_TYPE.COMMON_STATUS)" :key="dict.value"
          ...
          <el-form-item label="创建时间" prop="createTime">
            <el-date-picker
v-model="queryParams.createTime" value-format="YYYY-MM-DD HH:mm:ss" type="datetimerange"
          ...
          <el-form-item>
            ...
            <el-button type="info" plain @click="handleImportUserRole" v-hasPermi="['system:user:import']">
              <Icon icon="ep:upload-filled" /> 批量授权
            </el-button>
            <el-button
type="success" plain @click="handleExport" :loading="exportLoading"
            ...
            <el-button
type="danger" plain :disabled="checkedIds.length === 0" @click="handleDeleteBatch"
      ...
      <ContentWrap>
        <el-table v-loading="loading" :data="list" @selection-change="handleRowCheckboxChange">
          ...
          <el-table-column label="工号" align="center" key="staffCode">
            <template #default="scope">
              <div v-if="scope.row.staffCode">
                {{scope.row.staffCode}}
              </div>
              <div v-else>
                -
          ...
          <el-table-column label="主部门" align="center" key="deptName" prop="deptName" :show-overflow-tooltip="true" />
          <el-table-column label="所在部门" align="center" key="deptNames" prop="deptNames" :show-overflow-tooltip="true" />
          <el-table-column label="岗位" align="center" prop="postNamesStr" :show-overflow-tooltip="true" />
...
:total="total" v-model:page="queryParams.pageNo" v-model:limit="queryParams.pageSize"
  ...
  <!-- 批量授权 -->
  <UserRoleImportForm ref="userRoleImportFormRef" @success="getList" />
</template>
...
/** 批量授权 */
const userRoleImportFormRef = ref()
const handleImportUserRole = () => {
  userRoleImportFormRef.value.open()
}
