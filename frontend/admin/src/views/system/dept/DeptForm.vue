  ...
  <Dialog v-model="dialogVisible" :title="dialogTitle">
    ...
    >
      ...
      <el-form-item label="负责人" prop="leaderUserIds">
        <el-select
          v-model="formData.leaderUserIds"
          multiple
          filterable
          placeholder="请选择负责人"
        >
      ...
      <el-form-item label="部门层级全称" prop="deptLevelName">
        <el-input v-model="formData.deptLevelName" placeholder="部门层级全称（系统自动计算）" :disabled="true" />
      </el-form-item>
...
const formData = ref({
  ...
  name: undefined,
  sort: undefined,
  leaderUserIds: [], // 负责人ID数组
  phone: undefined,
  email: undefined,
  status: CommonStatusEnum.ENABLE,
  deptLevelName: undefined, // 部门层级全称
