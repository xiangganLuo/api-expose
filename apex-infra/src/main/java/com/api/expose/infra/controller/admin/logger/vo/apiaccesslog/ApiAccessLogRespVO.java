package com.api.expose.infra.controller.admin.logger.vo.apiaccesslog;
...
import com.api.expose.infra.enums.DictTypeConstants;
...
public class ApiAccessLogRespVO {
    ...
    @Schema(description = "结果提示", example = "APEX，牛逼！")
    @ExcelProperty("结果提示")
