package com.api.expose.infra.websocket;
...
import com.api.expose.framework.websocket.core.sender.WebSocketMessageSender;
import com.api.expose.framework.websocket.core.util.WebSocketFrameworkUtils;
import com.api.expose.infra.websocket.message.DemoReceiveMessage;
import com.api.expose.infra.websocket.message.DemoSendMessage;
...
public class DemoWebSocketMessageListener implements WebSocketMessageListener<DemoSendMessage> {
    ...
    @Autowired(required = false) // 由于 apex.websocket.enable 配置项，可以关闭 WebSocket 的功能，所以这里只能不强制注入
