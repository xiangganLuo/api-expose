package com.api.expose.infra.controller.admin.codegen;
...
import com.api.expose.infra.controller.admin.codegen.vo.CodegenCreateListReqVO;
import com.api.expose.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import com.api.expose.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
import com.api.expose.infra.controller.admin.codegen.vo.CodegenUpdateReqVO;
import com.api.expose.infra.controller.admin.codegen.vo.table.CodegenTablePageReqVO;
import com.api.expose.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import com.api.expose.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import com.api.expose.infra.convert.codegen.CodegenConvert;
...
import com.api.expose.infra.service.codegen.CodegenService;
...
import static com.api.expose.framework.security.core.util.SecurityFrameworkUtils.getLoginUserNickname;
import static com.api.expose.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "apex"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "APEX")
    })
